" -----------------------------------------------------------------------------
" File: gruvbox-modified-by-retr0.vim
" Description: Retro groove color scheme for Vim, modified 
" Author: morhetz <morhetz@gmail.com> + retr0
...
let s:gb.bright_green   = ['#1BE322', 142]     " 184-187-38 (old) 27-227-34 (new)
let s:gb.bright_yellow  = ['#fabd2f', 214]     " 250-189-47 
let s:gb.bright_blue    = ['#83a598', 109]     " 131-165-152
let s:gb.bright_purple  = ['#d3869b', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#8ec07c', 108]     " 142-192-124
let s:gb.bright_orange  = ['#fe8019', 208]     " 254-128-25
let s:gb.bright_custom1 = ['#ff9933', 242]     " 255, 153, 51
...
if s:is_dark
  ...
  let s:blue    = s:gb.light0_soft                " was bright_blue, now light0_soft
  let s:purple  = s:gb.bright_purple
  let s:aqua    = s:gb.bright_aqua
  let s:orange  = s:gb.bright_orange
  let s:custom1 = s:gb.bright_custom1
else
...
if g:gruvbox_improved_strings == 0
  call s:HL('String',  s:custom1, s:none, s:italicize_strings)
else
